...
<body>
    <div id="app">
        ...
        <!-- Navbar & Hero Start - AHORA CON ANCHO COMPLETO -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0 pe-4">
                            ...
                            @guest
                                ...
                                @endif
                            @else
                                <a href="{{route('food.display.cart')}}" class="nav-item nav-link">
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Navarro</a>, All Right Reserved. 
                        <br><br>
